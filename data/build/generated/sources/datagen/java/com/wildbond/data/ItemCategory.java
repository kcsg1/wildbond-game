...
public enum ItemCategory {
  ...
  /** CSV 문자열로 상수를 찾는다. */
  public static ItemCategory fromCsv(String value) {
    for (ItemCategory candidate : values()) {
      if (candidate.csvValue.equals(value)) {
        return candidate;
      }
    }
    throw new IllegalArgumentException("ItemCategory 값이 아니다: " + value);
  }
}
